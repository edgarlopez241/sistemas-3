...
const insertarSubscripcion = async(req,res,next)=>{
    try {
        ...
        const result = await pool.query('INSERT INTO public."SubscripcionUsuario" (id_usuario, tipo_subscripcion, modalidad_temporal, fecha_vencimiento, estatus_subscripcion) VALUES ($1, $2, $3, $4, $5, $6);', 
        [
            id_usuario,
            tipo_subscripcion,
            modalidad_temporal,
