...
function Register() {
  ...
  const handleSubmit = (event) => {
    ...
    setSubmitted(true);
    if (!validateName(firstName) || !validateName(lastName) || !validateEmail(email) || !validatePassword(password) || !validateConfirmPassword(password, confirmPassword) || !validateBirthDate(birthDate) || !validateGender(gender) || !validatePhoneNumber(phoneNumber)) {
      return;
    }
          ...
          <Grid align='center'>
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate>
             ...
             <TextField
                ...
                sx={{ display: 'block', margin: "0.5rem 0" }}
                InputLabelProps={{ style: { color: '#ffffff' } }}
                error={submitted && (!validateEmail() || duplicateEmailError)} 
                helperText={submitted && !validateEmail() ? (email ? 'Formato de correo inválido' : 'El campo correo electrónico no puede estar vacío') : (duplicateEmailError ? 'El correo ya está registrado' : '')} 
              />
              <TextField
                variant="outlined"
                margin="normal"
              ...
              <TextField
                ...
                sx={{ display: 'block', margin: "0.5rem 0" }}
                InputLabelProps={{ style: { color: '#ffffff' } }}
                error={submitted && !validateConfirmPassword()}
                helperText={submitted && !validateConfirmPassword() ? 'Las contraseñas no coinciden' : ''}
              />
              <TextField
                variant="outlined"
                margin="normal"
            ...
            <Link component={RouterLink} to="/login">¿Ya tienes una cuenta? ¡Inicia sesión!</Link>
          </Grid>
        </Paper>
      </Grid>
    </ThemeProvider>
